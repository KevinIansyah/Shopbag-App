                  ...
                  @foreach ($carts as $item)
                    <div class="rounded-lg border border-gray-200 bg-white p-4">
                      <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-4 md:space-y-0">
                          ...
                          <div class="w-full md:order-2 md:max-w-md">
                            ...
                            <div class="flex items-center gap-2">
                              ...
                              <p class="text-sm font-normal text-black">Total <span
                                  class="font-semibold text-black">{{ $item->quantity }}</span>
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <button type="button"
                          class="flex items-center text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center transition-all duration-200">
