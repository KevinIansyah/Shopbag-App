        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          @foreach ($products as $item)
            <a href="{{ route('product.show', ['product' => $item->slug]) }}"
              ...
              @endif
              <div class="px-2 py-2">
                <h5 class="text-sm font-bold tracking-tight text-gray-900 dark:text-white line-clamp-2">
                  {{ $item->name }}</h5>
                ...
                <div class="flex items-center justify-between">
                  <span
                    class="text-sm font-bold text-gray-900 dark:text-white">{{ 'Rp ' . number_format($item->price, 0, ',', '.') }}</span>
