        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div class="flex items-center">
              ...
              <p class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400">Admin</p>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <section class="bg-gray-50 dark:bg-gray-900">
        <div class="">
          <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden p-4">
                ...
                <tbody>
                  {{-- @for ($i = 0; $i < 100; $i++)
                    <tr class="border-b dark:border-gray-700">
                      <td class="px-4 py-3">Apple iMac 27</td>
            ...
            <!-- Tabel Nav -->
            {{-- <nav
              class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 pt-4"
