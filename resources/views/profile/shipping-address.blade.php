        ...
        <div class="w-full h-auto bg-white dark:bg-gray-800">
          <div class="lg:rounded-lg lg:p-4">
            ...
            <div class="">
              ...
              <div class="mt-4 p-4 border border-gray-100 rounded flex flex-col md:flex-row items:start md:items-center gap-4">
                <div class="w-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <form action="#" class="h-[calc(100vh-96px)] md:h-auto md:max-h-[70vh] overflow-y-auto">
          <div class="grid gap-4 mb-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              <label for="notes_courier"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Notes For Courier</label>
            ...
            success: function(response) {
              if (response.rajaongkir && response.rajaongkir.results) {
                ...
                $.each(response.rajaongkir.results, function(index, city) {
                  $('#city').append('<option value="' + city.city_id + '">' + city.type + ' ' + city.city_name +
                    '</option>');
                });
