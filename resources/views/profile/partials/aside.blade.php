    ...
    <ul class="space-y-2">
      <li>
        <a href="{{ route('profile.index', ['p' => 'profile']) }}"
          class="{{ $currentPage === 'profile' ? 'text-white bg-red-500 hover:bg-red-600 focus:ring-red-300' : 'text-gray-900 bg-white hover:bg-gray-100 focus:ring-gray-300' }} flex items-center px-2 py-2.5 text-sm font-normal rounded-lg focus:ring-4 focus:outline-none group transition-all duration-200">
      ...
      <li>
        <a href="{{ route('profile.index', ['p' => 'shipping-address']) }}"
          class="{{ $currentPage === 'shipping-address' ? 'text-white bg-red-500 hover:bg-red-600 focus:ring-red-300' : 'text-gray-900 bg-white hover:bg-gray-100 focus:ring-gray-300' }} flex items-center px-2 py-2.5 text-sm font-normal rounded-lg focus:ring-4 focus:outline-none group transition-all duration-200">
          <div class="w-6 h-6 flex items-center justify-center">
      ...
      <li>
        <button type="button"
          class="{{ $currentPage === 'waiting-for-payment' || $currentPage === 'transaction-list' ? 'text-white bg-red-500 hover:bg-red-600 focus:ring-red-300' : 'text-gray-900 bg-white hover:bg-gray-100 focus:ring-gray-300' }} flex items-center px-2 py-2.5 w-full text-sm font-normal rounded-lg focus:ring-4 focus:outline-none group transition-all duration-200"
