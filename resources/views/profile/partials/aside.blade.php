<aside id="default-sidebar"
  ...
  <div
    ...
    <ul class="space-y-2">
      <li>
        <a href="{{ route('profile.profile', ['p' => 'profile']) }}"
          ...
          <div class="w-6 h-6 flex items-center justify-center">
            <i class="fa-duotone fa-solid fa-user text-base"></i>
          </div>
          <span class="ml-3">Profile</span>
        </a>
      </li>
      <li>
        <a href="{{ route('profile.profile', ['p' => 'shipping-address']) }}"
          ...
          <div class="w-6 h-6 flex items-center justify-center">
            <i class="fa-duotone fa-solid fa-truck-fast text-base"></i>
          </div>
      ...
      <li>
        <button type="button"
          ...
          <div class="w-6 h-6 flex items-center justify-center">
            <i class="fa-duotone fa-solid fa-circle-dollar text-base"></i>
          </div>
      ...
      <li>
        <a href="{{ route('profile.profile', ['p' => 'set-password']) }}"
          ...
          <div class="w-6 h-6 flex items-center justify-center">
            <i class="fa-duotone fa-solid fa-lock text-base"></i>
          </div>
          <span class="ml-3">Set Password</span>
        </a>
      </li>
      {{-- <li>
        <a href="{{ route('profile.profile', ['p' => 'deactive-account']) }}"
      ...
      <li>
        <form method="POST" action="{{ route('logout') }}">
          ...
          <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();"
            ...
            <div class="w-6 h-6 flex items-center justify-center">
              <i class="fa-duotone fa-solid fa-right-from-bracket text-base"></i>
            </div>
